    ...
    <ArticleWrapper>
      ...
      <ArticleMain>
        <p>
          ...
          week, or even month. In an attempt to grab consumers’ attention, some
          stores start the so-called presales as early as Monday. Nevertheless,
          in most countries, the peak of shoppers’ interest falls on the same
          day. In the United Kingdom, Google Trends data for 19-25 November 2018
          shows that one third of all queries related to Black Friday sales were
          recorded on Friday (33.9 per cent). Nevertheless, the interest of
          customers starts to grow on Wednesday and fades on Saturday. This
          tendency is characteristic for not only the UK but other countries as
          well.
        </p>
        ...
        <p>
          ...
          date, which may explain the gradual increase of interest in this event
          even a few weeks before it takes place.
        </p>
