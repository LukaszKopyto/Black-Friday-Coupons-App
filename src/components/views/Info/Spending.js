      ...
      <ArticleWrapper>
        ...
        <ArticleMain>
          <p>
            ...
            brick-and-mortar sales. Those who will cho262ose more than one
            channel are ready to spend around £315. It is equivalent to €351. In
            other countries, shoppers have a smaller budget in mind, like
            Germans (€211), Italians (€203) or Russians (€120). In contrast,
            consumers who declare to spend record-breaking amounts come from the
            USA (€429) and Canada (€381).
          </p>
          <picture>
            <ArticleImage
              src={spendingImage}
          ...
          <p>
            ...
            percent chose tablets. Purchasing with smartphones was a global
            trend, noted among others in Germany, Turkey, or Indonesia.
          </p>
